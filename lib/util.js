(() => {
    ...
    getCssResource = exports.getCssResource = (() => {
        let cssMap = {
    ...
    getConfigFile = exports.getConfigFile = (callback, transform) => {
        try {
    ...
    extractScript = exports.extractScript = (html) => {
        setTimeout(() => {
    ...
    makeTemplate = exports.makeTemplate = (sources) => {
    ...
    showConfigFile = exports.showConfigFile = (callback) => {
        getConfigFile((err, json, config) => {
            if (err) {
                console.log(err.name, err.message);
            } else {
                console.log(json);
    ...
    exports.startGenerator = (fiddle, filename) => {
        gen = makeFile(fiddle, filename);
        gen.next();
    };

    writeFile = exports.writeFile = (filename, data, callback) => {
